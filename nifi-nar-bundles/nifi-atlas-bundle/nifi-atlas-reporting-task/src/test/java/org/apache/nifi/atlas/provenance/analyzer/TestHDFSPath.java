...
public class TestHDFSPath {
    ...
    private void testHDFSPath(String transitUri, FilesystemPathsLevel filesystemPathsLevel, String expectedPath) {
        ...
        assertEquals("hdfs_path", dataSet.getTypeName());
        assertEquals(expectedPath, dataSet.getAttribute(ATTR_NAME));
        assertEquals(expectedPath + "@namespace1", dataSet.getAttribute(ATTR_QUALIFIED_NAME));
    }
}
