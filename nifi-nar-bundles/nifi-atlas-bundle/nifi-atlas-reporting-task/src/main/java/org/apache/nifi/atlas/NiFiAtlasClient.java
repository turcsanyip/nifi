...
import static org.apache.nifi.atlas.model.NiFiFlow.EntityChangeType.AS_IS;
import static org.apache.nifi.atlas.model.NiFiFlow.EntityChangeType.CREATED;
import static org.apache.nifi.atlas.model.NiFiFlow.EntityChangeType.DELETED;
import static org.apache.nifi.atlas.model.NiFiFlow.EntityChangeType.UPDATED;
...
public class NiFiAtlasClient implements AutoCloseable {
    ...
    public NiFiFlow fetchNiFiFlow(String rootProcessGroupId, String namespace) throws AtlasServiceException {
        ...
        final NiFiFlow nifiFlow = new NiFiFlow(rootProcessGroupId, namespace);
    ...
    private AtlasEntity registerNiFiFlowEntity(final NiFiFlow nifiFlow) throws AtlasServiceException {
        ...
        flowEntity.setAttribute(ATTR_QUALIFIED_NAME, nifiFlow.getQualifiedName());
